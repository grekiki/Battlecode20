...
public strictfp class RobotPlayer {
	...
	static void runLandscaper() throws GameActionException {
		...
		if (Math.random() < 0.8 && bestPlaceToBuildWall != null) {
	...
	// the second entry in every message tells us what kind of message it is. e.g. 0
	// means it contains the HQ location
