...
/**
 * Ta razred bo skrbel da se vsi paketi ki jih �elimo poslati, dejansko po�ljejo. Vsako potezo naj bi se poklical blockchain.checkQueue() da se znebimo paketov iz seznama. Razred bo preveril cene v prej�njem bloku, in glede na le te dolo�il koliko pla�ati da pridemo v naslednji blok. �e prej�nji blok ni poln, potem placamo 1. Druga�e matchamo najcenejsi paket v prejsnjem bloku.
 * 
 * @author grego
 *
 */
class blockchain{
	...
	static final int LOC_SLABA_SUROVINA=3;
	static final int NADGRADNJA_SUROVINE=4;
	static final int LOC_RAFINERIJA=10;
	static final int LOC_TOVARNA_DRONOV=20;
